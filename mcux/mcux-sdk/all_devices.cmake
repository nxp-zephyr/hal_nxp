...
if(${MCUX_DEVICE} STREQUAL "MCXN946_cm33_core0")
    list(APPEND CMAKE_MODULE_PATH
        ${CMAKE_CURRENT_LIST_DIR}/devices/MCXN946
    )

    include(all_lib_device_MCXN946_cm33_core0)

endif()

if(${MCUX_DEVICE} STREQUAL "MCXN946_cm33_core1")
    list(APPEND CMAKE_MODULE_PATH
        ${CMAKE_CURRENT_LIST_DIR}/devices/MCXN946
    )

    include(all_lib_device_MCXN946_cm33_core1)

endif()

if(${MCUX_DEVICE} STREQUAL "MCXN547_cm33_core1")
    list(APPEND CMAKE_MODULE_PATH
        ${CMAKE_CURRENT_LIST_DIR}/devices/MCXN547
    )

    include(all_lib_device_MCXN547_cm33_core1)
...
if(${MCUX_DEVICE} STREQUAL "MCXN547_cm33_core0")
    ...
    include(all_lib_device_MCXN547_cm33_core0)

endif()

if(${MCUX_DEVICE} STREQUAL "MCXN546_cm33_core0")
    list(APPEND CMAKE_MODULE_PATH
        ${CMAKE_CURRENT_LIST_DIR}/devices/MCXN546
    )

    include(all_lib_device_MCXN546_cm33_core0)

endif()

if(${MCUX_DEVICE} STREQUAL "MCXN546_cm33_core1")
    list(APPEND CMAKE_MODULE_PATH
        ${CMAKE_CURRENT_LIST_DIR}/devices/MCXN546
    )

    include(all_lib_device_MCXN546_cm33_core1)

endif()

if(${MCUX_DEVICE} STREQUAL "MCXN947_cm33_core1")
    list(APPEND CMAKE_MODULE_PATH
        ${CMAKE_CURRENT_LIST_DIR}/devices/MCXN947
    )

    include(all_lib_device_MCXN947_cm33_core1)
...
if(${MCUX_DEVICE} STREQUAL "MCXN947_cm33_core0")
    ...
    include(all_lib_device_MCXN947_cm33_core0)
