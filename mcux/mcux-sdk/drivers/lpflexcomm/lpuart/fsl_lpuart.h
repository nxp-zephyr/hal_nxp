...
#define FSL_LPUART_DRIVER_VERSION (MAKE_VERSION(2, 1, 1))
/*@}*/
...
/*! @brief Some enum name was modified,these macro are used to support cmsis driver. */
#define kLPUART_RxOverrunFlag            kLPUART_RxOverrunInterruptFlag
#define kLPUART_RxDataRegFullFlag        kLPUART_RxDataRegFullInterruptFlag
#define kLPUART_IdleLineFlag             kLPUART_IdleLineInterruptFlag
#define kLPUART_TransmissionCompleteFlag kLPUART_TransmissionCompleteInterruptFlag
#define kLPUART_NoiseErrorFlag           kLPUART_NoiseErrorInterruptFlag
#define kLPUART_FramingErrorFlag         kLPUART_FramingErrorInterruptFlag
#define kLPUART_LinBreakFlag             kLPUART_LinBreakInterruptFlag
#define kLPUART_FramingErrorFlag         kLPUART_FramingErrorInterruptFlag
#define kLPUART_ParityErrorFlag          kLPUART_ParityErrorInterruptFlag
...
#endif
        kLPUART_ParityErrorInterruptFlag | kLPUART_FramingErrorInterruptFlag | kLPUART_NoiseErrorInterruptFlag |
        kLPUART_RxOverrunInterruptFlag | kLPUART_IdleLineInterruptFlag | kLPUART_RxActiveEdgeInterruptFlag
#if defined(FSL_FEATURE_LPUART_HAS_FIFO) && FSL_FEATURE_LPUART_HAS_FIFO
...
#endif
        kLPUART_ParityErrorInterruptFlag | kLPUART_FramingErrorInterruptFlag | kLPUART_NoiseErrorInterruptFlag |
        kLPUART_RxOverrunInterruptFlag | kLPUART_IdleLineInterruptFlag | kLPUART_RxDataRegFullInterruptFlag |
        kLPUART_TransmissionCompleteInterruptFlag | kLPUART_TxDataRegEmptyInterruptFlag | kLPUART_RxActiveFlag |
        kLPUART_RxActiveEdgeInterruptFlag
#if defined(FSL_FEATURE_LPUART_HAS_FIFO) && FSL_FEATURE_LPUART_HAS_FIFO
