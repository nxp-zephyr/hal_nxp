...
#if defined(TRDC_GENERAL_OFFSET) && TRDC_GENERAL_OFFSET
...
#if defined(TRDC_DOMAIN_ASSIGNMENT_OFFSET) && TRDC_DOMAIN_ASSIGNMENT_OFFSET
...
#if defined(TRDC_GENERAL_OFFSET)
...
#if defined(TRDC_FLW_OFFSET) && TRDC_FLW_OFFSET
/*!
