...
enum _isi_interrupt
{
    ...
    kISI_AxiReadErrorInterrupt =
        ISI_CHNL_IER_AXI_RD_ERR_EN_MASK, /*!< AXI Bus error when reading the input memory. */

    kISI_OverflowAlertVInterrupt =
        ISI_CHNL_IER_PANIC_V_BUF_EN_MASK, /*!< V output buffer overflow threshold accrossed. */
    ...
    kISI_OverflowVInterrupt =
        ISI_CHNL_IER_OFLW_V_BUF_EN_MASK, /*!< V output buffer overflow interrupt. */

    kISI_OverflowAlertUInterrupt =
        ISI_CHNL_IER_PANIC_U_BUF_EN_MASK, /*!< U output buffer overflow threshold accrossed. */
    ...
    kISI_OverflowUInterrupt =
        ISI_CHNL_IER_OFLW_U_BUF_EN_MASK, /*!< U output buffer overflow interrupt. */

    kISI_OverflowAlertYInterrupt =
        ISI_CHNL_IER_PANIC_Y_BUF_EN_MASK, /*!< Y output buffer overflow threshold accrossed. */
    //kISI_ExcessOverflowYInterrupt =
    //    ISI_CHNL_IER_EXCS_OFLW_Y_BUF_EN_MASK, /*!< Y output buffer excess overflow interrupt. */
    kISI_OverflowYInterrupt =
        ISI_CHNL_IER_OFLW_Y_BUF_EN_MASK, /*!< Y output buffer overflow interrupt. */
};
...
typedef enum _isi_threshold
{
    ...
    kISI_Threshold25Percent = 4U, /*!< Panic will assert when the buffers are 25% full. */
    kISI_Threshold50Percent = 8U, /*!< Panic will assert when the buffers are 50% full. */
    kISI_Threshold75Percent = 12U  /*!< Panic will assert when the buffers are 75% full. */
} isi_threshold_t;
...
{
    return base->CHNL_STS & ~ISI_CHNL_STS_RSVD0_MASK;
}
