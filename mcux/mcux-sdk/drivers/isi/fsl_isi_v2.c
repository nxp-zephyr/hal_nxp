...
void ISI_SetConfig(ISI_Type *base, const isi_config_t *config)
{
    ...
    reg = base->CHNL_CTRL;
    reg &= ~(ISI_CHNL_CTRL_CHNL_BYPASS_MASK | ISI_CHNL_CTRL_CHAIN_BUF_MASK |
             ISI_CHNL_CTRL_VC_ID_MASK | ISI_CHNL_CTRL_SRC_TYPE_MASK | ISI_CHNL_CTRL_SRC_MASK);
    reg |= ISI_CHNL_CTRL_CHNL_BYPASS(config->isChannelBypassed) | ISI_CHNL_CTRL_CHAIN_BUF(config->chainMode) |
           ISI_CHNL_CTRL_VC_ID(config->mipiChannel) |
    ...
    reg &= ~(ISI_CHNL_OUT_BUF_CTRL_PANIC_SET_THD_V_MASK | ISI_CHNL_OUT_BUF_CTRL_PANIC_SET_THD_U_MASK |
             ISI_CHNL_OUT_BUF_CTRL_PANIC_SET_THD_Y_MASK);
    reg |= ISI_CHNL_OUT_BUF_CTRL_PANIC_SET_THD_V(config->thresholdV) |
           ISI_CHNL_OUT_BUF_CTRL_PANIC_SET_THD_U(config->thresholdU) |
           ISI_CHNL_OUT_BUF_CTRL_PANIC_SET_THD_Y(config->thresholdY);
