...
#define FSL_FLASH_DRIVER_VERSION (MAKE_VERSION(1, 1, 0)) /*!< Version 1.1.0. */
/*@}*/
 ...
 *        The start address need to be page-aligned.
 * @param end The end address of the desired flash memory to be programed.
 ...
 *        The start address need to be page-aligned.
 * @param end The end address of the desired ifr memory to be programed.
 * @param seed A pointer to the source buffer of seed that is to be programmed
 *            into the signature register .
