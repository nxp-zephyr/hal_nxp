...
static inline void CLOCK_EnableClock(clock_ip_name_t name)
{
    ...
    (*(volatile uint32_t *)((uint32_t)name)) &= (~MRCC_CC_MASK);
    (*(volatile uint32_t *)((uint32_t)name)) |= (MRCC_CC_MASK & (uint32_t)kCLOCK_IpClkControl_fun1);

    if (((*(volatile uint32_t *)((uint32_t)name)) & MRCC_PR_MASK) == MRCC_PR_MASK)
    {
        (*(volatile uint32_t *)((uint32_t)name)) |= MRCC_RSTB_MASK;
    }
...
static inline void CLOCK_EnableClockLPMode(clock_ip_name_t name, clock_ip_control_t control)
{
    ...
    (*(volatile uint32_t *)((uint32_t)name)) &= (~MRCC_CC_MASK);
    (*(volatile uint32_t *)((uint32_t)name)) |= (MRCC_CC_MASK & (uint32_t)control);
...
static inline void CLOCK_DisableClock(clock_ip_name_t name)
{
    ...
    (*(volatile uint32_t *)((uint32_t)name)) &= (uint32_t)kCLOCK_IpClkControl_fun0;
...
static inline void CLOCK_SetIpSrc(clock_ip_name_t name, clock_ip_src_t src)
{
     ...
     */
    (*(volatile uint32_t *)((uint32_t)name)) = reg & (~MRCC_CC_MASK);
...
{
    return (bool)(SCG0->SOSCCSR & SCG_SOSCCSR_SOSCERR_MASK);
}
...
{
    return (bool)(SCG0->SOSCCSR & SCG_SOSCCSR_SOSCVLD_MASK);
}
...
{
    return (bool)(SCG0->SIRCCSR & SCG_SIRCCSR_SIRCVLD_MASK);
}
...
{
    return (bool)(SCG0->FIRCCSR & SCG_FIRCCSR_FIRCERR_MASK);
}
...
{
    return (bool)(SCG0->FIRCCSR & SCG_FIRCCSR_FIRCVLD_MASK);
}
...
{
    return (bool)(SCG0->ROSCCSR & SCG_ROSCCSR_ROSCERR_MASK);
}
