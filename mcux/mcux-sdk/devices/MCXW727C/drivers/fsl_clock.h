...
/*!
 * @brief Clock source for TPM2.
 *
 * These options are for RF_CMC1->TPM2_CFG[CLK_MUX_SEL].
 */
typedef enum _tpm2_ip_src
{
    kCLOCK_Tpm2SrcCoreClk = 1U, /*!< Core Clock. */
    kCLOCK_Tpm2SrcSoscClk = 2U, /*!< Radio Oscillator. */
} tpm2_src_t;
...
typedef enum _clock_ip_name
{
    ...
    kCLOCK_Can1             = MAKE_MRCC_REGADDR(MRCC_BASE, 0x13C), /*!< Clock Can1 */
    ...
    kCLOCK_Sram0_NOECC      = MAKE_MRCC_REGADDR(MRCC_BASE, 0x42C), /*!< Clock Sram0 NOECC */
    kCLOCK_DSP0             = MAKE_MRCC_REGADDR(MRCC_BASE, 0x430), /*!< Clock DSPV */
    kCLOCK_DSP0_MUA         = MAKE_MRCC_REGADDR(MRCC_BASE, 0x434), /*!< Clock DSPV MUA */
    kCLOCK_Sram1_NOECC      = MAKE_MRCC_REGADDR(MRCC_BASE, 0x438), /*!< Clock Sram1 NOECC */
    kCLOCK_Rf_2p4ghz_bist   = MAKE_MRCC_REGADDR(MRCC_BASE, 0x43C), /*!< Clock rf_2p4ghz_bist */
...
/*!
 * @brief Enable the TPM2 clock.
 */
static inline void CLOCK_EnableTPM2(void)
{
    RF_CMC1->TPM2_CFG |= RF_CMC1_TPM2_CFG_CGC(1U);
}
...
/*!
 * @brief Set the clock source for TPM2.
 *
 * @param src Clock source to set.
 */
static inline void CLOCK_SetTpm2Src(tpm2_src_t src)
{
    uint32_t reg = RF_CMC1->TPM2_CFG;

    reg &= ~RF_CMC1_TPM2_CFG_CLK_MUX_SEL_MASK;

    reg |= RF_CMC1_TPM2_CFG_CLK_MUX_SEL(src);

    RF_CMC1->TPM2_CFG = reg;
}
