 ...
 * @return Return 0 if succeeded, otherwise return error code.
 */
int CE_MatrixInvHerm_CF32(float *pAinv, float *pA, float *pScratch, int M,
 ...
 * @return Return 0 if succeeded, otherwise return error code.
 */
int CE_MatrixEvdHerm_CF32(float *pLambdaOut, float *pUout, float *pUin,
                           float *pScratch, int M, float tol, int max_iter, uint8_t flag_packedInput);
