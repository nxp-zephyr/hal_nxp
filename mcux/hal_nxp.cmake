...
elseif (CONFIG_SOC_MCX_N947_CPU0)
include(device_system_MCXN947_cm33_core0)
elseif (CONFIG_SOC_MCX_N947_CPU1)
...
include_driver_ifdef(CONFIG_DMA_MCUX_EDMA		edma4		driver_edma4)
else()
...
include_driver_ifdef(CONFIG_SPI_MCUX_LPSPI		lpflexcomm	driver_lpspi)
else()
...
include_driver_ifdef(CONFIG_UART_MCUX_LPUART		lpflexcomm	driver_lpuart)
else()
...
include_driver_ifdef(CONFIG_I2C_MCUX_LPI2C		lpflexcomm	driver_lpi2c)
else()
...
include_driver_ifdef(CONFIG_SOC_FAMILY_MCX		mcx_spc		driver_mcx_spc)
include_driver_ifdef(CONFIG_MCUX_FLEXIO			flexio		driver_flexio)
include_driver_ifdef(CONFIG_DISPLAY_MCUX_FLEXIO_LCDIF	flexio		driver_flexio_mculcd)
...
elseif((${MCUX_DEVICE} MATCHES "MIMXRT(5|6)") OR ${MCUX_DEVICE} MATCHES "MCXN.4.")
