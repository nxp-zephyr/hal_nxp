...
/*!
 * @file MIMX9529_ca55_COMMON.h
 * @version 2.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for MIMX9529_ca55
 *
 * CMSIS Peripheral Access Layer for MIMX9529_ca55
 */

#if !defined(MIMX9529_CA55_COMMON_H_)
#define MIMX9529_CA55_COMMON_H_                  /**< Symbol preventing repeated inclusion */
...
#define NUMBER_OF_INT_VECTORS 447                /**< Number of interrupts in the Vector table */
...
typedef enum IRQn {
  ...
  RESERVED34_IRQn              = 34,               /**< CTI trigger outputs from CM7 platform  (internal: CTIIRQ[0]) */
  RESERVED35_IRQn              = 35,               /**< CTI trigger outputs from CM33 platform  (internal: CTIIRQ[0]) */
  RESERVED36_IRQn              = 36,               /**< CTI trigger outputs from CA55 platform  (internal: nCTIIRQ[0]) */
  RESERVED37_IRQn              = 37,               /**< Performance Unit Interrupts from CA55 platform (interrnally:  PMUIRQ[0]) */
  RESERVED38_IRQn              = 38,               /**< ECC error with potential data corruption or loss of coherency from CA55 platform L3 Cache */
  RESERVED39_IRQn              = 39,               /**< 1-bit or 2-bit ECC or Parity error from CA55 platform L3 Cache */
  CAN1_IRQn                    = 40,               /**< AONMIX CAN-FD Interrupt from busoff */
  CAN1_ERROR_IRQn              = 41,               /**< AONMIX CAN-FD Correctable error interrupt */
  GPIO1_0_IRQn                 = 42,               /**< AONMIX GPIO interrupt request 0 */
  GPIO1_1_IRQn                 = 43,               /**< AONMIX GPIO interrupt request 1 */
  I3C1_IRQn                    = 44,               /**< AONMIX I3C interrupt request */
  LPI2C1_IRQn                  = 45,               /**< AONMIX LPI2C Master interrupt */
  LPI2C2_IRQn                  = 46,               /**< AONMIX LPI2C Master interrupt */
  LPIT1_IRQn                   = 47,               /**< AONMIX LPIT global interrupt */
  LPSPI1_IRQn                  = 48,               /**< AONMIX LPSPI interrupt */
  LPSPI2_IRQn                  = 49,               /**< AONMIX LPSPI interrupt */
  LPTMR1_IRQn                  = 50,               /**< AONMIX LPTMR async interrupt */
  LPUART1_IRQn                 = 51,               /**< AONMIX LPUART TX interrupt */
  LPUART2_IRQn                 = 52,               /**< AONMIX LPUART TX interrupt */
  RESERVED53_IRQn              = 53,               /**< AONMIX Sentinel MU0 SideA RX full interrupt, masked by BLK_CTRL_S_AONMIX */
  RESERVED54_IRQn              = 54,               /**< AONMIX Sentinel MU1 SideA RX full interrupt, masked by BLK_CTRL_S_AONMIX */
  RESERVED55_IRQn              = 55,               /**< AONMIX Sentinel MU2 SideA RX full interrupt, masked by BLK_CTRL_S_AONMIX */
  RESERVED56_IRQn              = 56,               /**< AONMIX Sentinel MU3 SideA RX full interrupt, masked by BLK_CTRL_S_AONMIX */
  RESERVED57_IRQn              = 57,               /**< AONMIX Sentinel MU4 SideA RX full interrupt, masked by BLK_CTRL_S_AONMIX */
  RESERVED58_IRQn              = 58,               /**< AONMIX Sentinel MU5 SideA RX full interrupt, masked by BLK_CTRL_S_AONMIX */
  RESERVED59_IRQn              = 59,               /**< V2X-FH MU APCH0 (APP0) A_TX interrupt */
  RESERVED60_IRQn              = 60,               /**< V2X-FH MU APHSM1 (HSM1) A_TX interrupt */
  TPM1_IRQn                    = 61,               /**< AONMIX LPTPM global interrupt */
  TPM2_IRQn                    = 62,               /**< AONMIX LPTPM global interrupt */
  WDOG1_IRQn                   = 63,               /**< AONMIX Watchdog interrupt request.  SRC reset source. */
  WDOG2_IRQn                   = 64,               /**< AONMIX Watchdog interrupt request.  SRC reset source. */
  TRDC_MGR_A_IRQn              = 65,               /**< AONMIX TRDC transfer error interrupt */
  SAI1_IRQn                    = 66,               /**< AONMIX SAI TX interrupt */
  RESERVED67_IRQn              = 67,               /**< AONMIX M33 PS Tag Parity Error */
  CM33_ECC_MCM_IRQn            = 68,               /**< AONMIX M33 TCM Error interrupt */
  RESERVED69_IRQn              = 69,               /**< M7MIX ECC Multi-bit error */
  CAN2_IRQn                    = 70,               /**< WAKEUPMIX CAN-FD Interrupt from busoff */
  CAN2_ERROR_IRQn              = 71,               /**< WAKEUPMIX CAN-FD Correctable error interrupt */
  CAN3_IRQn                    = 72,               /**< WAKEUPMIX CAN-FD Interrupt from busoff */
  CAN3_ERROR_IRQn              = 73,               /**< WAKEUPMIX CAN-FD Correctable error interrupt */
  WDOG6_IRQn                   = 74,               /**< DISPLAYMIX Watchdog interrupt request. SRC reset source. */
  RESERVED75_IRQn              = 75,               /**< Additional inverted version of Interrupt added for s500_scm_halt_ack_irq. Which could be uzseful for Sentinel Wakeup */
  RESERVED76_IRQn              = 76,               /**< s500.sentinel_irq_glue_s500_irq_req4 is connected with ocotp_cont_edc_err */
  DISPLAY_MIX_IRQn             = 77,               /**< Local Dimming Interrupt */
  FLEXIO1_IRQn                 = 78,               /**< WAKEUPMIX FLEXIO interrupt */
  FLEXIO2_IRQn                 = 79,               /**< WAKEUPMIX FLEXIO interrupt */
  RESERVED80_IRQn              = 80,               /**< Reserved */
  GPIO2_0_IRQn                 = 81,               /**< WAKEUPMIX GPIO interrupt request 0 */
  GPIO2_1_IRQn                 = 82,               /**< WAKEUPMIX GPIO interrupt request 1 */
  GPIO3_0_IRQn                 = 83,               /**< WAKEUPMIX GPIO interrupt request 0 */
  GPIO3_1_IRQn                 = 84,               /**< WAKEUPMIX GPIO interrupt request 1 */
  GPIO4_0_IRQn                 = 85,               /**< WAKEUPMIX GPIO interrupt request 0 */
  GPIO4_1_IRQn                 = 86,               /**< WAKEUPMIX GPIO interrupt request 1 */
  GPIO5_0_IRQn                 = 87,               /**< WAKEUPMIX GPIO interrupt request 0 */
  GPIO5_1_IRQn                 = 88,               /**< WAKEUPMIX GPIO interrupt request 1 */
  I3C2_IRQn                    = 89,               /**< WAKEUPMIX I3C interrupt request */
  LPI2C3_IRQn                  = 90,               /**< WAKEUPMIX LPI2C Master interrupt */
  LPI2C4_IRQn                  = 91,               /**< WAKEUPMIX LPI2C Master interrupt */
  LPIT2_IRQn                   = 92,               /**< WAKEUPMIX LPIT global interrupt */
  LPSPI3_IRQn                  = 93,               /**< WAKEUPMIX LPSPI interrupt */
  LPSPI4_IRQn                  = 94,               /**< WAKEUPMIX LPSPI interrupt */
  LPTMR2_IRQn                  = 95,               /**< WAKEUPMIX LPTMR async interrupt */
  LPUART3_IRQn                 = 96,               /**< WAKEUPMIX LPUART TX interrupt */
  LPUART4_IRQn                 = 97,               /**< WAKEUPMIX LPUART TX interrupt */
  LPUART5_IRQn                 = 98,               /**< WAKEUPMIX LPUART TX interrupt */
  LPUART6_IRQn                 = 99,               /**< WAKEUPMIX LPUART TX interrupt */
  LPUART7_IRQn                 = 100,              /**< WAKEUPMIX LPUART TX interrupt */
  LPUART8_IRQn                 = 101,              /**< WAKEUPMIX LPUART TX interrupt */
  MTR_MSTR_IRQn                = 102,              /**< AONMIX MTR Master error interrupt */
  BBNSM_IRQn                   = 103,              /**< BBNSM Non-Secure external wakeup alarm */
  SYS_CTR1_IRQn                = 104,              /**< WAKEUPMIX System Counter compare interrupt 0 */
  TPM3_IRQn                    = 105,              /**< WAKEUPMIX LPTPM global interrupt */
  TPM4_IRQn                    = 106,              /**< WAKEUPMIX LPTPM global interrupt */
  TPM5_IRQn                    = 107,              /**< WAKEUPMIX LPTPM async interrupt */
  TPM6_IRQn                    = 108,              /**< WAKEUPMIX LPTPM async interrupt */
  WDOG3_IRQn                   = 109,              /**< WAKEUPMIX Watchdog interrupt request. SRC reset source. */
  WDOG4_IRQn                   = 110,              /**< WAKEUPMIX Watchdog interrupt request. SRC reset source. */
  WDOG5_IRQn                   = 111,              /**< WAKEUPMIX Watchdog interrupt request. SRC reset source. */
  TMPSNS1_THR1_IRQn            = 112,              /**< ANAMIX TempSensor non-secure interrupt from Threshold 1 */
  TMPSNS1_THR2_IRQn            = 113,              /**< ANAMIX TempSensor non-secure interrupt from Threshold 2 */
  TMPSNS1_DRDY_IRQn            = 114,              /**< ANAMIX TempSensor non-secure data ready interrupt */
  TMPSNS2_THR1_IRQn            = 115,              /**< CORTEXAMIX TempSensor non-secure interrupt from Threshold 1 */
  TMPSNS2_THR2_IRQn            = 116,              /**< CORTEXAMIX TempSensor non-secure interrupt from Threshold 2 */
  TMPSNS2_DRDY_IRQn            = 117,              /**< CORTEXAMIX TempSensor non-secure data ready interrupt */
  USDHC1_IRQn                  = 118,              /**< MEGAMIX uSDHC Enhanced SDHC Interrupt Request */
  USDHC2_IRQn                  = 119,              /**< MEGAMIX uSDHC Enhanced SDHC Interrupt Request */
  TRDC_MGR_W1_IRQn             = 120,              /**< WAKEUPMIX TRDC transfer error interrupt */
  TRDC_MGR_W2_IRQn             = 121,              /**< WAKEUPMIX TRDC transfer error interrupt */
  TRDC_MGR_N_IRQn              = 122,              /**< NOCMIX TRDC transfer error interrupt */
  ...
  RESERVED125_IRQn             = 125,              /**< DRAM Phy Critical Interrupt 0 */
  INTG_BOOTROM_DEBUG_CTRL_IRQn = 126,              /**< Cortex-A Cluster Debug Wakeup Request */
  DMA3_ERROR_IRQn              = 127,              /**< AONMIX EDMA error interrupt */
  DMA3_0_IRQn                  = 128,              /**< AONMIX EDMA channel 0 interrupt */
  DMA3_1_IRQn                  = 129,              /**< AONMIX EDMA channel 1 interrupt */
  DMA3_2_IRQn                  = 130,              /**< AONMIX EDMA channel 2 interrupt */
  DMA3_3_IRQn                  = 131,              /**< AONMIX EDMA channel 3 interrupt */
  DMA3_4_IRQn                  = 132,              /**< AONMIX EDMA channel 4 interrupt */
  DMA3_5_IRQn                  = 133,              /**< AONMIX EDMA channel 5 interrupt */
  DMA3_6_IRQn                  = 134,              /**< AONMIX EDMA channel 6 interrupt */
  DMA3_7_IRQn                  = 135,              /**< AONMIX EDMA channel 7 interrupt */
  DMA3_8_IRQn                  = 136,              /**< AONMIX EDMA channel 8 interrupt */
  DMA3_9_IRQn                  = 137,              /**< AONMIX EDMA channel 9 interrupt */
  DMA3_10_IRQn                 = 138,              /**< AONMIX EDMA channel 10 interrupt */
  DMA3_11_IRQn                 = 139,              /**< AONMIX EDMA channel 11 interrupt */
  DMA3_12_IRQn                 = 140,              /**< AONMIX EDMA channel 12 interrupt */
  DMA3_13_IRQn                 = 141,              /**< AONMIX EDMA channel 13 interrupt */
  DMA3_14_IRQn                 = 142,              /**< AONMIX EDMA channel 14 interrupt */
  DMA3_15_IRQn                 = 143,              /**< AONMIX EDMA channel 15 interrupt */
  DMA3_16_IRQn                 = 144,              /**< AONMIX EDMA channel 16 interrupt */
  DMA3_17_IRQn                 = 145,              /**< AONMIX EDMA channel 17 interrupt */
  DMA3_18_IRQn                 = 146,              /**< AONMIX EDMA channel 18 interrupt */
  DMA3_19_IRQn                 = 147,              /**< AONMIX EDMA channel 19 interrupt */
  DMA3_20_IRQn                 = 148,              /**< AONMIX EDMA channel 20 interrupt */
  DMA3_21_IRQn                 = 149,              /**< AONMIX EDMA channel 21 interrupt */
  DMA3_22_IRQn                 = 150,              /**< AONMIX EDMA channel 22 interrupt */
  DMA3_23_IRQn                 = 151,              /**< AONMIX EDMA channel 23 interrupt */
  DMA3_24_IRQn                 = 152,              /**< AONMIX EDMA channel 24 interrupt */
  DMA3_25_IRQn                 = 153,              /**< AONMIX EDMA channel 25 interrupt */
  DMA3_26_IRQn                 = 154,              /**< AONMIX EDMA channel 26 interrupt */
  DMA3_27_IRQn                 = 155,              /**< AONMIX EDMA channel 27 interrupt */
  DMA3_28_IRQn                 = 156,              /**< AONMIX EDMA channel 28 interrupt */
  DMA3_29_IRQn                 = 157,              /**< AONMIX EDMA channel 29 interrupt */
  DMA3_30_IRQn                 = 158,              /**< AONMIX EDMA channel 30 interrupt */
  DMA5_2_ERROR_IRQn            = 159,              /**< WAKEUPMIX EDMA error interrupt */
  DMA5_2_0_1_IRQn              = 160,              /**< WAKEUPMIX EDMA channel 0 interrupt */
  DMA5_2_2_3_IRQn              = 161,              /**< WAKEUPMIX EDMA channel 2 interrupt */
  DMA5_2_4_5_IRQn              = 162,              /**< WAKEUPMIX EDMA channel 4 interrupt */
  DMA5_2_6_7_IRQn              = 163,              /**< WAKEUPMIX EDMA channel 6 interrupt */
  DMA5_2_8_9_IRQn              = 164,              /**< WAKEUPMIX EDMA channel 8 interrupt */
  DMA5_2_10_11_IRQn            = 165,              /**< WAKEUPMIX EDMA channel 10 interrupt */
  DMA5_2_12_13_IRQn            = 166,              /**< WAKEUPMIX EDMA channel 12 interrupt */
  DMA5_2_14_15_IRQn            = 167,              /**< WAKEUPMIX EDMA channel 14 interrupt */
  DMA5_2_16_17_IRQn            = 168,              /**< WAKEUPMIX EDMA channel 16 interrupt */
  DMA5_2_18_19_IRQn            = 169,              /**< WAKEUPMIX EDMA channel 18 interrupt */
  DMA5_2_20_21_IRQn            = 170,              /**< WAKEUPMIX EDMA channel 20 interrupt */
  DMA5_2_22_23_IRQn            = 171,              /**< WAKEUPMIX EDMA channel 22 interrupt */
  DMA5_2_24_25_IRQn            = 172,              /**< WAKEUPMIX EDMA channel 24 interrupt */
  DMA5_2_26_27_IRQn            = 173,              /**< WAKEUPMIX EDMA channel 26 interrupt */
  DMA5_2_28_29_IRQn            = 174,              /**< WAKEUPMIX EDMA channel 28 interrupt */
  DMA5_2_30_31_IRQn            = 175,              /**< WAKEUPMIX EDMA channel 30 interrupt */
  DMA5_2_32_33_IRQn            = 176,              /**< WAKEUPMIX EDMA channel 32 interrupt */
  DMA5_2_34_35_IRQn            = 177,              /**< WAKEUPMIX EDMA channel 34 interrupt */
  DMA5_2_36_37_IRQn            = 178,              /**< WAKEUPMIX EDMA channel 36 interrupt */
  DMA5_2_38_39_IRQn            = 179,              /**< WAKEUPMIX EDMA channel 38 interrupt */
  DMA5_2_40_41_IRQn            = 180,              /**< WAKEUPMIX EDMA channel 40 interrupt */
  DMA5_2_42_43_IRQn            = 181,              /**< WAKEUPMIX EDMA channel 42 interrupt */
  DMA5_2_44_45_IRQn            = 182,              /**< WAKEUPMIX EDMA channel 44 interrupt */
  DMA5_2_46_47_IRQn            = 183,              /**< WAKEUPMIX EDMA channel 46 interrupt */
  DMA5_2_48_49_IRQn            = 184,              /**< WAKEUPMIX EDMA channel 48 interrupt */
  DMA5_2_50_51_IRQn            = 185,              /**< WAKEUPMIX EDMA channel 50 interrupt */
  DMA5_2_52_53_IRQn            = 186,              /**< WAKEUPMIX EDMA channel 52 interrupt */
  DMA5_2_54_55_IRQn            = 187,              /**< WAKEUPMIX EDMA channel 54 interrupt */
  DMA5_2_56_57_IRQn            = 188,              /**< WAKEUPMIX EDMA channel 56 interrupt */
  DMA5_2_58_59_IRQn            = 189,              /**< WAKEUPMIX EDMA channel 58 interrupt */
  DMA5_2_60_61_IRQn            = 190,              /**< WAKEUPMIX EDMA channel 60 interrupt */
  DMA5_2_62_63_IRQn            = 191,              /**< WAKEUPMIX EDMA channel 62 interrupt */
  ELE_GROUP1_IRQn              = 192,              /**< Sentinel Group 1 reset source if no s500 reference clock is detected.  Output synchronized to 32khz clk. */
  ELE_GROUP2_IRQn              = 193,              /**< Sentinel Group 2 reset source s500 reference clock is not detected or too slow.  Output synchronized to ref1_clk. */
  ELE_GROUP3_IRQn              = 194,              /**< Sentinel Group 3 reset source s500 reference clock is not detected or too slow.  Output synchronized to ref1_clk. */
  DBG_TRACE_IRQn               = 195,              /**< JTAGSW DAP MDM-AP SRC reset source */
  JTAGC_IRQn                   = 196,              /**< JTAGC SRC reset source (the JTAGC used for boundary scan, not JTAGC used for password authentication) */
  SYSREQRST_CM33_IRQn          = 197,              /**< CM33 SYSREQRST SRC reset source */
  LOCKUP_CM33_IRQn             = 198,              /**< CM33 LOCKUP SRC reset source */
  SYSREQRST_CM7_IRQn           = 199,              /**< CM7 SYSREQRST SRC reset source */
  LOCKUP_CM7_IRQn              = 200,              /**< CM7 LOCKUP SRC reset source */
  SAI2_IRQn                    = 201,              /**< NETCMIX SAI TX interrupt */
  SAI3_IRQn                    = 202,              /**< WAKEUPMIX SAI TX interrupt */
  SAI4_IRQn                    = 203,              /**< WAKEUPMIX SAI TX interrupt */
  SAI5_IRQn                    = 204,              /**< WAKEUPMIX SAI TX interrupt */
  USB1_WAKEUP_IRQn             = 205,              /**< USB-1 (USB 2.0) Wake-up Interrupt */
  USB2_WAKEUP_IRQn             = 206,              /**< USB-2 (USB 2.0) Wake-up Interrupt */
  USB1_IRQn                    = 207,              /**< USB-1 (USB 2.0 Controller) Interrupt */
  USB2_IRQn                    = 208,              /**< USB-2 (USB 2.0 Controller) Interrupt */
  LPSPI5_IRQn                  = 209,              /**< WAKEUPMIX LPSPI interrupt */
  LPSPI6_IRQn                  = 210,              /**< WAKEUPMIX LPSPI interrupt */
  LPSPI7_IRQn                  = 211,              /**< WAKEUPMIX LPSPI interrupt */
  LPSPI8_IRQn                  = 212,              /**< WAKEUPMIX LPSPI interrupt */
  LPI2C5_IRQn                  = 213,              /**< WAKEUPMIX LPI2C Master interrupt */
  LPI2C6_IRQn                  = 214,              /**< WAKEUPMIX LPI2C Master interrupt */
  LPI2C7_IRQn                  = 215,              /**< WAKEUPMIX LPI2C Master interrupt */
  LPI2C8_IRQn                  = 216,              /**< WAKEUPMIX LPI2C Master interrupt */
  PDM_HWVAD_ERROR_IRQn         = 217,              /**< AONMIXMIX PDM interrupt */
  PDM_HWVAD_EVENT_IRQn         = 218,              /**< AONMIXMIX PDM interrupt */
  PDM_ERROR_IRQn               = 219,              /**< AONMIXMIX PDM interrupt */
  PDM_EVENT_IRQn               = 220,              /**< AONMIXMIX PDM interrupt */
  RESERVED221_IRQn             = 221,              /**< WAKEUPMIX AUDIO XCVR interrupt */
  RESERVED222_IRQn             = 222,              /**< WAKEUPMIX AUDIO XCVR interrupt */
  USDHC3_IRQn                  = 223,              /**< MEGAMIX uSDHC Enhanced SDHC Interrupt Request */
  RESERVED224_IRQn             = 224,              /**< OCRAM ECC single bit error */
  RESERVED225_IRQn             = 225,              /**< OCRAM ECC multi bit error */
  ...
  I3C1_RAW_IRQ_GLUE_IRQn       = 235,              /**< I3C1 wakeup irq after double sync */
  I3C2_RAW_IRQ_GLUE_IRQn       = 236,              /**< I3C2 wakeup irq after double sync */
  ...
  MU7_B_IRQn                   = 239,              /**< WAKEUPMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUB */
  MU8_B_IRQn                   = 240,              /**< WAKEUPMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUB */
  XSPI_SLV_IRQn                = 241,              /**< WAKEUPMIX XSPI Responder */
  FCCU0_IRQn                   = 242,              /**< AONMIX FCCU Interrupt Reaction 0 */
  FCCU1_IRQn                   = 243,              /**< AONMIX FCCU Interrupt Reaction 1 */
  FCCU2_IRQn                   = 244,              /**< AONMIX FCCU Interrupt Reaction 2 */
  STCU_IRQn                    = 245,              /**< AONMIX STCU Selftest end Interrupt */
  DISP_IRQSTEER0_IRQn          = 246,              /**< DISPLAYMIX IRQSTEER 0: Common Control */
  DISP_IRQSTEER1_IRQn          = 247,              /**< DISPLAYMIX IRQSTEER 1: Display 0 Domain 0 */
  DISP_IRQSTEER2_IRQn          = 248,              /**< DISPLAYMIX IRQSTEER 2: Display 0 Domain 1 */
  DISP_IRQSTEER3_IRQn          = 249,              /**< DISPLAYMIX IRQSTEER 3: Display 1 Domain 0 */
  DISP_IRQSTEER4_IRQn          = 250,              /**< DISPLAYMIX IRQSTEER 4: Display 1 Domain 1 */
  DISP_IRQSTEER7_IRQn          = 251,              /**< DISPLAYMIX IRQSTEER 7: Blitter */
  MU_C1_IRQn                   = 252,              /**< CAMERAMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  ISI_0_IRQn                   = 253,              /**< CAMERAMIX ISI interrupt Channel 0 */
  ISP_IRQn                     = 254,              /**< ISP Processing Interrupt - Context 0 */
  M7MIX_IRQn                   = 255,              /**< M7MIX MCM interrupt */
  ...
  MSGINTR1_IRQn                = 268,              /**< MSGINTR Instance 1, Interrupt 1 */
  MSGINTR2_IRQn                = 269,              /**< MSGINTR Instance 2, Interrupt 1 */
  RESERVED270_IRQn             = 270,              /**< V2X-FH MU APCH1 (APP1) A_TX interrupt */
  RESERVED271_IRQn             = 271,              /**< V2X-FH MU APHSM2 (HSM2) A_TX interrupt */
  TRDC_MGR_C_IRQn              = 272,              /**< CAMERAMIX TRDC transfer error interrupt */
  TRDC_MGR_D_IRQn              = 273,              /**< DISPLAYMIX TRDC transfer error interrupt */
  TRDC_MGR_E_IRQn              = 274,              /**< NETCMIX TRDC transfer error interrupt */
  TRDC_MGR_G_IRQn              = 275,              /**< GPUMIX TRDC transfer error interrupt */
  TRDC_MGR_H_IRQn              = 276,              /**< HSIOMIX TRDC transfer error interrupt */
  TRDC_MGR_V_IRQn              = 277,              /**< VPUMIX TRDC transfer error interrupt */
  ERM_A_IRQn                   = 278,              /**< AONMIX ERM Single bit corrected ECC Error */
  RESERVED279_IRQn             = 279,              /**< M7MIX ERM Single bit corrected ECC Error */
  ERM_W_IRQn                   = 280,              /**< WAKEUPMIX ERM Single bit corrected ECC Error */
  ERM_ML_IRQn                  = 281,              /**< NPUMIX ERM Single bit corrected ECC Error */
  DMA5_3_ERROR_IRQn            = 282,              /**< WAKEUPMIX ACP EDMA error interrupt */
  OCRAM_C_IRQn                 = 283,              /**< OCRAM_C ECC multiple bit or address error */
  ...
  RESERVED286_IRQn             = 286,              /**< V2X-FH MU APSHE (SHE) A_TX interrupt */
  RESERVED287_IRQn             = 287,              /**< V2X-FH MU SCU/APDEBUG (DEBUG) B_TX interrupt */
  DMA5_3_0_1_IRQn              = 288,              /**< WAKEUPMIX ACP EDMA channel 0 interrupt */
  DMA5_3_2_3_IRQn              = 289,              /**< WAKEUPMIX ACP EDMA channel 2 interrupt */
  DMA5_3_4_5_IRQn              = 290,              /**< WAKEUPMIX ACP EDMA channel 4 interrupt */
  DMA5_3_6_7_IRQn              = 291,              /**< WAKEUPMIX ACP EDMA channel 6 interrupt */
  DMA5_3_8_9_IRQn              = 292,              /**< WAKEUPMIX ACP EDMA channel 8 interrupt */
  DMA5_3_10_11_IRQn            = 293,              /**< WAKEUPMIX ACP EDMA channel 10 interrupt */
  DMA5_3_12_13_IRQn            = 294,              /**< WAKEUPMIX ACP EDMA channel 12 interrupt */
  DMA5_3_14_15_IRQn            = 295,              /**< WAKEUPMIX ACP EDMA channel 14 interrupt */
  DMA5_3_16_17_IRQn            = 296,              /**< WAKEUPMIX ACP EDMA channel 16 interrupt */
  DMA5_3_18_19_IRQn            = 297,              /**< WAKEUPMIX ACP EDMA channel 18 interrupt */
  DMA5_3_20_21_IRQn            = 298,              /**< WAKEUPMIX ACP EDMA channel 20 interrupt */
  DMA5_3_22_23_IRQn            = 299,              /**< WAKEUPMIX ACP EDMA channel 22 interrupt */
  DMA5_3_24_25_IRQn            = 300,              /**< WAKEUPMIX ACP EDMA channel 24 interrupt */
  DMA5_3_26_27_IRQn            = 301,              /**< WAKEUPMIX ACP EDMA channel 26 interrupt */
  DMA5_3_28_29_IRQn            = 302,              /**< WAKEUPMIX ACP EDMA channel 28 interrupt */
  DMA5_3_30_31_IRQn            = 303,              /**< WAKEUPMIX ACP EDMA channel 30 interrupt */
  DMA5_3_32_33_IRQn            = 304,              /**<  WAKEUPMIX ACP EDMA channel 32 interrupt */
  DMA5_3_34_35_IRQn            = 305,              /**<  WAKEUPMIX ACP EDMA channel 34 interrupt */
  DMA5_3_36_37_IRQn            = 306,              /**<  WAKEUPMIX ACP EDMA channel 36 interrupt */
  DMA5_3_38_39_IRQn            = 307,              /**<  WAKEUPMIX ACP EDMA channel 38 interrupt */
  DMA5_3_40_41_IRQn            = 308,              /**<  WAKEUPMIX ACP EDMA channel 40 interrupt */
  DMA5_3_42_43_IRQn            = 309,              /**<  WAKEUPMIX ACP EDMA channel 42 interrupt */
  DMA5_3_44_45_IRQn            = 310,              /**<  WAKEUPMIX ACP EDMA channel 44 interrupt */
  DMA5_3_46_47_IRQn            = 311,              /**<  WAKEUPMIX ACP EDMA channel 46 interrupt */
  DMA5_3_48_49_IRQn            = 312,              /**<  WAKEUPMIX ACP EDMA channel 48 interrupt */
  DMA5_3_50_51_IRQn            = 313,              /**<  WAKEUPMIX ACP EDMA channel 50 interrupt */
  DMA5_3_52_53_IRQn            = 314,              /**<  WAKEUPMIX ACP EDMA channel 52 interrupt */
  DMA5_3_54_55_IRQn            = 315,              /**<  WAKEUPMIX ACP EDMA channel 54 interrupt */
  DMA5_3_56_57_IRQn            = 316,              /**<  WAKEUPMIX ACP EDMA channel 56 interrupt */
  DMA5_3_58_59_IRQn            = 317,              /**<  WAKEUPMIX ACP EDMA channel 58 interrupt */
  DMA5_3_60_61_IRQn            = 318,              /**<  WAKEUPMIX ACP EDMA channel 60 interrupt */
  DMA5_3_62_63_IRQn            = 319,              /**<  WAKEUPMIX ACP EDMA channel 62 interrupt */
  ...
  RESERVED335_IRQn             = 335,              /**< CODA980 VPU Encoder */
  RESERVED336_IRQn             = 336,              /**< NETC iEPRC PCI INT (one per each of two RC-EC) */
  RESERVED337_IRQn             = 337,              /**< NETC iEPRC PCI INT (one per each of two RC-EC) */
  ...
  RESERVED342_IRQn             = 342,              /**< PCIe miscellaneous interrupts */
  RESERVED343_IRQn             = 343,              /**< PCIe Controller EDMA channel interrupt */
  RESERVED344_IRQn             = 344,              /**< Reserved */
  RESERVED345_IRQn             = 345,              /**< Reserved */
  RESERVED346_IRQn             = 346,              /**< Reserved */
  RESERVED347_IRQn             = 347,              /**< Reserved */
  RESERVED348_IRQn             = 348,              /**< Reserved */
  RESERVED349_IRQn             = 349,              /**< Reserved */
  RESERVED350_IRQn             = 350,              /**< NPU Functional interrupt */
  RESERVED351_IRQn             = 351,              /**< NPU Fault interrupt */
  RESERVED352_IRQn             = 352,              /**< Reserved */
  RESERVED353_IRQn             = 353,              /**< Reserved */
  RESERVED354_IRQn             = 354,              /**< Reserved */
  RESERVED355_IRQn             = 355,              /**< Reserved */
  RESERVED356_IRQn             = 356,              /**< Reserved */
  RESERVED357_IRQn             = 357,              /**< Reserved */
  RESERVED358_IRQn             = 358,              /**< Reserved */
  RESERVED359_IRQn             = 359,              /**< Reserved */
  RESERVED360_IRQn             = 360,              /**< Reserved */
  RESERVED361_IRQn             = 361,              /**< Reserved */
  RESERVED362_IRQn             = 362,              /**< Reserved */
  RESERVED363_IRQn             = 363,              /**< Reserved */
  RESERVED364_IRQn             = 364,              /**< Reserved */
  RESERVED365_IRQn             = 365,              /**< Reserved */
  RESERVED366_IRQn             = 366,              /**< Reserved */
  LP_HDSK_GSKT_IRQn            = 367,              /**< SRC/GPC Low Power Handshake Gasket interrupt request for system management */
  MU_C2_IRQn                   = 368,              /**< CAMERAMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  MU_C3_IRQn                   = 369,              /**< CAMERAMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  MU_C4_IRQn                   = 370,              /**< CAMERAMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  MU_C5_IRQn                   = 371,              /**< CAMERAMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  MU_C6_IRQn                   = 372,              /**< CAMERAMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  MU_C7_IRQn                   = 373,              /**< CAMERAMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  MU_C8_IRQn                   = 374,              /**< CAMERAMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  MU_C9_IRQn                   = 375,              /**< CAMERAMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  ISI_1_IRQn                   = 376,              /**< CAMERAMIX ISI interrupt Channel 1 */
  ISI_2_IRQn                   = 377,              /**< CAMERAMIX ISI interrupt Channel 2 */
  ISI_3_IRQn                   = 378,              /**< CAMERAMIX ISI interrupt Channel 3 */
  ISI_4_IRQn                   = 379,              /**< CAMERAMIX ISI interrupt Channel 4 */
  ISI_5_IRQn                   = 380,              /**< CAMERAMIX ISI interrupt Channel 5 */
  ISI_6_IRQn                   = 381,              /**< CAMERAMIX ISI interrupt Channel 6 */
  ISI_7_IRQn                   = 382,              /**< CAMERAMIX ISI interrupt Channel 7 */
  DMA5_4_ERROR_IRQn            = 383,              /**< CAMERAMIX EDMA error interrupt */
  DMA5_4_0_1_IRQn              = 384,              /**< CAMERAMIX EDMA channel 0 interrupt */
  DMA5_4_2_3_IRQn              = 385,              /**< CAMERAMIX EDMA channel 2 interrupt */
  DMA5_4_4_5_IRQn              = 386,              /**< CAMERAMIX EDMA channel 4 interrupt */
  DMA5_4_6_7_IRQn              = 387,              /**< CAMERAMIX EDMA channel 6 interrupt */
  DMA5_4_8_9_IRQn              = 388,              /**< CAMERAMIX EDMA channel 8 interrupt */
  DMA5_4_10_11_IRQn            = 389,              /**< CAMERAMIX EDMA channel 10 interrupt */
  DMA5_4_12_13_IRQn            = 390,              /**< CAMERAMIX EDMA channel 12 interrupt */
  DMA5_4_14_15_IRQn            = 391,              /**< CAMERAMIX EDMA channel 14 interrupt */
  DMA5_4_16_17_IRQn            = 392,              /**< CAMERAMIX EDMA channel 16 interrupt */
  DMA5_4_18_19_IRQn            = 393,              /**< CAMERAMIX EDMA channel 18 interrupt */
  DMA5_4_20_21_IRQn            = 394,              /**< CAMERAMIX EDMA channel 20 interrupt */
  DMA5_4_22_23_IRQn            = 395,              /**< CAMERAMIX EDMA channel 22 interrupt */
  DMA5_4_24_25_IRQn            = 396,              /**< CAMERAMIX EDMA channel 24 interrupt */
  DMA5_4_26_27_IRQn            = 397,              /**< CAMERAMIX EDMA channel 26 interrupt */
  DMA5_4_28_29_IRQn            = 398,              /**< CAMERAMIX EDMA channel 28 interrupt */
  DMA5_4_30_31_IRQn            = 399,              /**< CAMERAMIX EDMA channel 30 interrupt */
  ...
  CSI1_IRQn                    = 406,              /**< CAMERAMIX CSI1 (Standalone MIPI-CSI) interrupt */
  CSI2_IRQn                    = 407,              /**< CAMERAMIX CSI2 (Combo MIPI-CSI/DSI) interrupt */
  ASRC1_IRQn                   = 408,              /**< mirq_asrc1_b */
  RESERVED409_IRQn             = 409,              /**< Reserved interrupt */
  RESERVED410_IRQn             = 410,              /**< Reserved interrupt */
  RESERVED411_IRQn             = 411,              /**< Reserved interrupt */
  RESERVED412_IRQn             = 412,              /**< Reserved interrupt */
  RESERVED413_IRQn             = 413,              /**< Reserved interrupt */
  RESERVED414_IRQn             = 414,              /**< Reserved interrupt */
  RESERVED415_IRQn             = 415,              /**< Reserved */
  ASRC2_IRQn                   = 416,              /**< mirq_asrc1_b */
  RESERVED417_IRQn             = 417,              /**< Reserved interrupt */
  RESERVED418_IRQn             = 418,              /**< Reserved interrupt */
  RESERVED419_IRQn             = 419,              /**< Reserved interrupt */
  RESERVED420_IRQn             = 420,              /**< Reserved interrupt */
  RESERVED421_IRQn             = 421,              /**< Reserved interrupt */
  RESERVED422_IRQn             = 422,              /**< Reserved interrupt */
  NOC_VPU_IRQn                 = 423,              /**< Reserved interrupt */
  NOC_DISPLAY_IRQn             = 424,              /**< Reserved interrupt */
  NOC_CAMERA_IRQn              = 425,              /**< Reserved interrupt */
  NOC_HSIO_IRQn                = 426,              /**< Reserved interrupt */
  NOC_WAKEUP_IRQn              = 427,              /**< Reserved interrupt */
  NOC_CENTRAL_IRQn             = 428,              /**< Reserved interrupt */
  ERM_DISPLAY_IRQn             = 429,              /**< DISPLAYMIX ERM Single bit corrected ECC Error */
  RESERVED430_IRQn             = 430,              /**< Reserved */
  SAI6_IRQn                    = 431,              /**< WAKEUPMIX SAI TX interrupt */
  XSPI1_0_IRQn                 = 432,              /**< xspi1 all interrupts ORed output for EENV0 (MEENV) */
  XSPI1_1_IRQn                 = 433,              /**< xspi1 all interrupts ORed output for EENV1 (MEENV) */
  XSPI1_2_IRQn                 = 434,              /**< xspi1 all interrupts ORed output for EENV2 (MEENV) */
  XSPI1_3_IRQn                 = 435,              /**< xspi1 all interrupts ORed output for EENV3 (MEENV) */
  XSPI1_4_IRQn                 = 436,              /**< xspi1 all interrupts ORed output for EENV4 (MEENV) */
  RESERVED437_IRQn             = 437,              /**< Anamix Gllitch Detector output (da_ip_voltage_glitch_detector_cln16ffc). It's a latch signal. It can be cleared.  Positive polarity i.e interrupt is generated when 0-->1 */
  RESERVED438_IRQn             = 438,              /**< Anamix VDET output (da_ip_vdetect_c16ffc). Detects high threshold on Core supply. It's a latch signal. It can be cleared.  Positive polarity i.e interrupt is generated when 0-->1 */
  CCM_IRQn                     = 439,              /**< LPCG Timeout interrupt generated by CCGR (CCM) */
  MU_D1_IRQn                   = 440,              /**< DISPLAYMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  MU_D2_IRQn                   = 441,              /**< DISPLAYMIX MU Ored of all (tx,rx,gp,core,murip) interrupt to MUA */
  GPT2_IRQn                    = 442,              /**< WAKEUPMIX GPT2 interrupt */
  GPT3_IRQn                    = 443,              /**< WAKEUPMIX GPT2 interrupt */
  GPT4_IRQn                    = 444,              /**< WAKEUPMIX GPT2 interrupt */
  GPT5_IRQn                    = 445,              /**< WAKEUPMIX GPT2 interrupt */
  LPSPI9_IRQn                  = 446               /**< DISPLAYMIX LPSPI interrupt */
} IRQn_Type;
...
#ifndef MIMX9529_ca55_SERIES
#define MIMX9529_ca55_SERIES
#endif
/* CPU specific feature definitions */
#include "MIMX9529_ca55_features.h"
