                                                      ...
                                                      uint32_t *length)
{
    ...
    {
        errorCode =
            USB_DeviceStallEndpoint(handle, (uint8_t)(USB_CONTROL_ENDPOINT) |
                                                ((uint8_t)USB_IN << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT));
        errorCode =
            USB_DeviceStallEndpoint(handle, (uint8_t)(USB_CONTROL_ENDPOINT) |
                                                ((uint8_t)USB_OUT << USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_SHIFT));
    }
    else
    {
